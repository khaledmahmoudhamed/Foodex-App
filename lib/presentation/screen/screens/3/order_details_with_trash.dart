...
class OrderDetailsWithTrash extends StatefulWidget {
  const OrderDetailsWithTrash({Key? key}) : super(key: key);

  @override
  State<OrderDetailsWithTrash> createState() => _OrderDetailsWithTrashState();
}

class _OrderDetailsWithTrashState extends State<OrderDetailsWithTrash> {
  int number = 1;
                    ...
                    Row(
                      children: [
                        const Padding(
                          ...
                          child: Image(
                              image: AssetImage('assets/orderDetails1.png')),
                        ),
                        Padding(
                    ...
                    Row(
                      children: [
                        const Padding(
                          padding: EdgeInsets.only(left: 20),
                          child: Image(
                              image: AssetImage('assets/orderDetails2.png')),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 15, left: 20),
                          child: Column(
                    ...
                    Row(
                      children: [
                        const Padding(
                          padding: EdgeInsets.only(left: 20),
                          child: Image(
                              image: AssetImage('assets/orderDetails3.png')),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 15, left: 20),
                          child: Column(
