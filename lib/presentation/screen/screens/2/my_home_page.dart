...
import '../1/upload_photo.dart';
import 'chat_folder/messages.dart';
import 'explor_menu.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const Image(image: AssetImage('assets/Promo Advertising.png')),
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushNamedAndRemoveUntil(context, screens.exploreRestaurant, (route) => false);
                      },
                      child: Text(
                        "View More",
                        style: TextStyle(
